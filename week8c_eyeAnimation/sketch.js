// let speed = 0.005; //set speed of noise traversal
// let noiseR = 0; //noise position for radius
// let noiseT = 1000; //noise position for theta using different starting points for R and T
// //to ensure they are related
